...
// singer 歌手页
const {
  mapState: singerState,
  mapActions: singerActions,
  mapGetters: singerGetters,
...
const {
  ...
  mapActions: playerActions,
  mapGetters: playerGetters,
...
const {
  ...
  mapGetters: playlistGetters,
  mapActions: playlistActions,
