            ...
            <div class="dialog-content theme">
                <template v-if="type==='confirm'">
                    ...
                    <div class="dialog-content-text-wrapper f-df f-jce">
                        <base-font class="dialog-content-text" :text="cancel" size="12" @bf-click="hide()"/>
                        <base-font class="dialog-content-text" :text="confirm" size="12" @bf-click="dialogConfirm()"/>
                    </div>
                </template>
                <template v-if="type==='list'">
                    ...
                    <div class="dialog-content-list-wrapper">
                        <ul class="dialog-content-list f-df f-fdc">
                            <li class="dialog-content-list-item f-df f-aic"
                                v-for="(item,index) in data"
                                :class="{'m-mt15':index>0}"
                                :key="index"
                                @click.stop.prevent="clickItem(item.id)"
                            >
                                <div class="dialog-content-list-item-img"
                                     :style="`background-image:url(${item.avatar}?param${avatarSize}y${avatarSize})`"></div>
