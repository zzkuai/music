    ...
    <div class="profile-info p-pv15">
      ...
      <div class="info-msg p-ph15">
        ...
        <transition name="fade">
          <ul
            class="o-oh"
            v-if="profile.introduction && profile.introduction.length > 0"
            v-show="visible"
          >
      ...
      >
        ...
        <svg-icon
          ...
          class="info-more-icon size-si"
        />
      </div>
    </div>
    <div
      class="profile-article p-ph15"
      v-if="profile.topicData && profile.topicData.length > 0"
    >
      ...
      <ul class="article-list">
        <li
          class="article_item m-mb15 f-df f-aic"
          v-for="item in profile.topicData"
          :key="item.id"
        >
          <div
            class="article_item-left"
            :style="`background-image:url(${item.rectanglePicUrl})`"
          ></div>
          <div class="article_item-right f-df f-fdc">
            ...
            <p>
              ...
              />
              <base-font
                class="article_item-right-count"
                :text="`阅读 ${articleReadCount(item.readCount)}`"
                size="12"
                color="text"
              />
            </p>
