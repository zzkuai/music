<template>
    ...
    <div v-else>
        <ul class="list ignore">
            <li class="list_item f-df" v-for="data in album" :key="data.id" @click="goToAlbum(data.id)">
                <div class="list_item-left">
                    <img v-lazy="`${data.picUrl}?param=120y120`" class="list_item-left-img" :alt="data.name">
                </div>
