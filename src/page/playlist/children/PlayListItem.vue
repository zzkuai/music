<template>
    <ul class="list ignore f-df f-fww">
        <li class="list-item m-mb15 ignore"
        ...
        >
            <div class="list-item-cover-wrapper o-oh p-pr" :class="{crown}">
                <img class="list-item-cover" v-lazy="`${ data.coverImgUrl }?param=${ coverSize }y${ coverSize }`"
                     alt="cover">
                <base-font class="list-item-count p-pa" :text="data.playCount | numberFormat" size="10" color="white"/>
                <svg-icon v-if="crown" icon-class="crown" class="list-item-icon size-si p-pa" color="white"></svg-icon>
            </div>
