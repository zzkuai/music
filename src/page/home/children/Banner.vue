    ...
    <div class="swiper-container banner p-pt15">
        <div class="swiper-wrapper">
            <div class="swiper-slide" v-for="(data,index) in list" :key="index">
                <img :src="`${data.imageUrl}?param=${swiperImgWidth}y${swiperImgHeight}`" alt="banner" class="banner-img">
                <div class="banner-tag f-df p-pa f-jac" :style="`backgroundColor:${data.titleColor};`">
