<template>
    <nav class="search-nav ignore p-pr">
        <ul class="search-nav-list f-df">
            <li class="search-nav-item f-fx1 f-df f-jac"
        ...
        <span class="search-nav-line theme-bg-reverse ignore p-pa" :style="navLineStyle"></span>
    </nav>
</template>
    ...
    export default {
        ...
        computed: {
            navLineStyle() {
                ...
                return {
                    left: SEARCH_NAV_ITEM_HALF_WIDTH - SEARCH_NAV_LINE_WIDTH / 2 + SEARCH_NAV_ITEM_WIDTH * index + 'px'
                };
            }
        },
        methods: {
