<template>
    <transition name="slide-down">
        <div class="com_player theme ignore f-df" v-show="playerVisible">
            ...
            <div class="com_player-center f-df f-fdc f-fx1 f-jcc o-oh" @click="goToPlayPage">
                <base-font class="line-one" text="" color="text">
                    <base-font :text="formatName"/>
                    <base-font :text="formatAlia" color="text"/>
                </base-font>
                <base-font class="line-one com_player-center-tip" :text="formatAuthor" color="text" size="12"/>
            </div>
            <div class="com_player-right f-df o-oh">
                <div @click="changePlayStatus" class="com_player-right-btn f-df f-fx1 f-jac">
                    <svg-icon :icon-class="playIcon" class="size-ll"/>
                </div>
                <div @click="showPlayList" class="com_player-right-btn f-df f-fx1 f-jac">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            formatAvatar() {
                if (!this.playInfo.avatar) return require('../../asset/images/lazyload_day.png');
